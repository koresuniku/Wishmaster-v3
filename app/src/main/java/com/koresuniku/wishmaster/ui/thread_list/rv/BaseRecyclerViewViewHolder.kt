...
open class BaseRecyclerViewViewHolder(itemView: View?, var viewType: Int) : RecyclerView.ViewHolder(itemView) {
    ...
    @BindView(R.id.post_image) lateinit var image: ImageView
    ...
    @BindView(R.id.post_image_5) lateinit var image5: ImageView
    @BindView(R.id.post_image_6) lateinit var image6: ImageView
    @BindView(R.id.post_image_7) lateinit var image7: ImageView
    @BindView(R.id.post_image_8) lateinit var image8: ImageView
    @BindView(R.id.webm_imageview) lateinit var webmImageView: ImageView
    ...
    @BindView(R.id.webm_imageview_5) lateinit var webmImageView5: ImageView
    @BindView(R.id.webm_imageview_6) lateinit var webmImageView6: ImageView
    @BindView(R.id.webm_imageview_7) lateinit var webmImageView7: ImageView
    @BindView(R.id.webm_imageview_8) lateinit var webmImageView8: ImageView
    @BindView(R.id.image_summary) lateinit var summary: TextView
    ...
    @BindView(R.id.image_summary_5) lateinit var summary5: TextView
    @BindView(R.id.image_summary_6) lateinit var summary6: TextView
    @BindView(R.id.image_summary_7) lateinit var summary7: TextView
